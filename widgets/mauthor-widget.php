...
class mauthor_widget_1 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'mAuthor', 'elementor-addon' );
	}
    ...
    protected function register_controls() { 
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => esc_html__( 'Content', 'mauthor_widget' ),
		...
		$this->add_control(
			'mauthor_link',
			[
				'label' => esc_html__( 'mAuthor link', 'mauthor_widget' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => esc_html__( 'Put link here', 'mauthor_widget' ),
			]
		);
        ...
        $this->add_control(
			'width',
			[
				'label' => esc_html__( 'Custom width', 'mauthor_widget' ),
        ...
        $this->start_controls_section(
			'style_section',
			[
				'label' => esc_html__( 'Style', 'mauthor_widget' ),
        ...
        $this->add_control(
			...
			[
				...
				'options' => [
					...
					'0 0 0 auto' => esc_html__( 'Right', 'mauthor_widget' ),
				],
				'selectors' => [
					'{{WRAPPER}} .container' => 'margin: {{VALUE}};',
				],
			]
		);
        ...
        $this->add_control(
			'radius',
			[
				'label' => esc_html__( 'Border radius in px', 'mauthor_widget' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'label_block' => true,
				'size_units' => [ 'px', '%' ],
				'range' => [
